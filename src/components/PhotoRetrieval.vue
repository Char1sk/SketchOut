    ...
    <div class="all">
        ...
        <div class="content">
            ...
            <div class="uploadPart">
                ...
                <!-- confirm button -->
                <el-button size="middle" type="success" @click="handleSubmitUpload">
                    上传到服务器
                </el-button>
            </div>
            ...
            <div class="resultPart">
                ...
                <!-- Download Button -->
                <el-button size="middle" type="primary" @click="handleDownloadIamge(resultImageUrl, 'name')">
                    下载结果图片
                </el-button>
            </div>
        </div>
...
.all {
    position: relative;
    height: 100%;
    background-image: linear-gradient(to right, rgb(50,141,99), rgb(52,91,161));
}
...
.all .content .middlePart .arrowLoading {
    background-image: linear-gradient(to right, rgb(51,119,126), rgb(51,113,134));
}
